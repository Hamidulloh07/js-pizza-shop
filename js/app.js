...
for (let i = 0; i < sizes.length; i++) {
  ...
  elSizeInput.classList.add("size-radio", "js-size-radio", "form-check-input", "me-1");
...
for (let i = 0; i < addls.length; i++) {
  ...
  elAddlInput.className = "addl-ingredient js-addl-ingredient form-check-input";
  elAddlInput.type = "checkbox";
  elAddlInput.name = "qoshimcha";
  elAddlInput.value = addls[i];

  elAddlSpan.className = "me-3";
...
for (let i = 0; i < toppings.length; i++) {
  ...
  elToppingInput.className = "topping-checkbox js-topping-checkbox form-check-input";
